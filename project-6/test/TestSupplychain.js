...
contract('SupplyChain', function (accounts) {
  ...
  before(async function () {
    contract = await SupplyChain.new({ from: ownerID })
    await contract.addFarmer(originFarmerID)
    await contract.addDistributor(distributorID)
    await contract.addRetailer(retailerID)
    await contract.addConsumer(consumerID)
  })
  ...
  it('Testing smart contract function harvestItem() that allows a farmer to harvest coffee', async () => {
    ...
    const resultBufferOne = await contract.fetchItemBufferOne.call(upc)
    const resultBufferTwo = await contract.fetchItemBufferTwo.call(upc)
  ...
  it('Testing smart contract function processItem() that allows a farmer to process coffee', async () => {
    ...
    var event = contract.Processed()
    await event.watch((err, res) => {
      processedEventEmitted = true
    })

    // Mark an item as Processed by calling function processtItem()
    await contract.processItem(upc, { from: originFarmerID })
  ...
  it('Testing smart contract function packItem() that allows a farmer to pack coffee', async () => {
    ...
    var event = contract.Packed()
    await event.watch((err, res) => {
      packedEventEmitted = true
    })

    // Mark an item as Packed by calling function packItem()
    await contract.packItem(upc, { from: originFarmerID })
  ...
  it('Testing smart contract function sellItem() that allows a farmer to sell coffee', async () => {
    ...
    await contract.sellItem(upc, productPrice, { from: originFarmerID })
  ...
  it('Testing smart contract function buyItem() that allows a distributor to buy coffee', async () => {
    ...
    var event = contract.Sold()
    await event.watch((err, res) => {
      soldEventEmitted = true
    })

    // Mark an item as Sold by calling function buyItem()
    await contract.buyItem(upc, {
      from: distributorID,
      value: productPrice
    })
  ...
  it('Testing smart contract function shipItem() that allows a distributor to ship coffee', async () => {
    ...
    var event = contract.Shipped()
    await event.watch((err, res) => {
      shippedEventEmitted = true
    })

    // Mark an item as Shipped by calling function shipItem()
    await contract.shipItem(upc, { from: distributorID })
  ...
  it('Testing smart contract function receiveItem() that allows a retailer to mark coffee received', async () => {
    ...
    var event = contract.Received()
    await event.watch((err, res) => {
      receivedEventEmitted = true
    })

    // Mark an item as Received by calling function receiveItem()
    await contract.receiveItem(upc, { from: retailerID })
  ...
  it('Testing smart contract function purchaseItem() that allows a consumer to purchase coffee', async () => {
    ...
    var event = contract.Purchased()
    await event.watch((err, res) => {
      purchasedEventEmitted = true
    })

    // Mark an item as Sold by calling function purchaseItem()
    await contract.purchaseItem(upc, { from: consumerID })
